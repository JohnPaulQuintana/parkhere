<!-- Table Section -->
<div class="max-w-[85rem] py-1 mx-auto">
    <!-- Card -->
                                        ...
                                        <div class="hs-tooltip">
                                            <div class="hs-tooltip-toggle">
                                                ...
                                                <span
                                                    ...
                                                    role="tooltip">
                                                    The indicator name of parking slot
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @foreach ($histories as $h)
                                <tr data-status="{{ $h->status }}">
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="pe-6 py-2">
                                            <a
                                                class="text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500">{{ $h->parkingLot->parkingSpace->stablishment_name }}</a>
                                        </div>
                                    </td>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <a
                                                class="parking_space text-sm flex items-center gap-2 text-violet-500 dark:text-neutral-400">
                                                <div>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <span
                                                data-booked_id="{{ $h->id }}"
                                                data-parking_price="{{ $h->price }}"
                                                data-parking_date="{{ $h->date }}"
                                                data-parking_stime="{{ $h->starting_time }}"
                                                data-parking_etime="{{ $h->end_time }}"
                                                data-slot_name="{{ $h->parkingLot->slot }}"
                                                data-total_charged="{{ $h->totalCharge->total }}"
                                                data-total_charged_status="{{ $h->totalCharge->status }}"
                                                data-establishment="{{ $h->parkingLot->parkingSpace->stablishment_name }}"
                                                class="parking_payment text-sm flex items-center gap-2 text-red-500 hover:cursor-pointer hover:text-red-700 dark:text-neutral-400">₱{{ $h->price }}
                                                {{ __('hrs') }}
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                          ...
                                          @endphp
                                            ...
                                            @if ($h->date == $currentDate && $h->status != 'cancelled')
                                              <span
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-2">
                                            <span
                                                class="text-sm text-gray-600 dark:text-neutral-400">{{ \Carbon\Carbon::parse($h->created_at)->format('l, F j, Y') }}</span>
                                        </div>
                                    </td>
                                                        ...
                                                        <div class="py-2 first:pt-0 last:pb-0">
                                                            <span
                                                                ...
                                                                @if ($h->status != 'cancelled' && $h->status != 'paid') 
                                                                    <a 
                                                                        data-booked_id="{{ $h->id }}" 
                                                                        data-slot_id="{{ $h->parking_lot_id }}" 
                                                                        data-slot_price="{{ $h->price }}"
                                                                        data-type="{{ $h->vehicle_type }}"
                                                                        data-color="{{ $h->vehicle_color }}"
                                                                        data-plate_number="{{ $h->plate_number }}"
                                                                        data-slot_name="{{ $h->parkingLot->slot }}"
                                                                        data-date="{{ $h->date }}"
                                                                        data-stime="{{ $h->starting_time }}"
                                                                        data-etime="{{ $h->end_time }}"
                                                                        class="editBooked flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                                                        href="#">
                                                                    ...
                                                                    <a 
                                                                        class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-red-500 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                                                        href="{{ route('user.reserved.slot.cancel', $h->id) }}">
                                                                        <i class="fa-solid fa-square-minus"></i>
                                                                        Cancel Reservation
                                                                    </a>
                                                                @elseif ($h->status == 'paid')
                                                                <a 
                                                                    class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-green-500 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                                                    >
                                                                    <i class="fa-solid fa-square-minus"></i>
                                                                    Your Reservation is Paid
                                                                </a>
                                                                @else
                                                                <a 
                                                                    class="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-red-500 focus:ring-2 focus:ring-blue-500 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300"
                                                                    >
                                                                    <i class="fa-solid fa-square-minus"></i>
