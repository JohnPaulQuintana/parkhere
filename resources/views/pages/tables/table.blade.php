              ...
              <div class="sm:col-span-2 md:grow">
                <div class="flex justify-end gap-x-2">
                  <div class="hs-dropdown [--placement:bottom-right] relative inline-block">
                    <button id="hs-create" type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800">
                        <i class="fa-solid fa-layer-plus flex-shrink-0"></i>
                        Create
                    </button>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                ...
                @foreach ($establishments as $e)
                    <tr>
                        ...
                        <td class="size-px whitespace-nowrap">
                            <div class="pe-6 py-2">
                            <a class="text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500" >{{ $e->stablishment_name }}</a>
                            </div>
                        </td>
                        
                        <td class="size-px whitespace-nowrap">
                            <div class="px-6 py-2">
                            <a data-id="{{ $e->id }}" class="parking_space text-sm flex items-center gap-2 text-violet-500 hover:cursor-pointer hover:text-violet-700 dark:text-neutral-400">
                                <div>
                                    <i class="fa-solid fa-square-parking"></i>
                                    {{ $e->parking_space_count }}
                                </div>
                        ...
                        <td class="size-px whitespace-nowrap">
                            <div class="px-6 py-2">
                                <span class="text-sm text-gray-600 dark:text-neutral-400">{{ \Carbon\Carbon::parse($e->created_at)->format('l, F j, Y') }}</span>
                            </div>
                        </td>
