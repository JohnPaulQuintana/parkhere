<div class="text-center">
    <button id="createModalBtn" type="button" class="hidden py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-createModal">
      Open modal
    </button>
  </div>
  
  <div id="hs-createModal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto">
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
      <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
        <div class="absolute top-2 end-2">
          <button type="button" class="flex justify-center items-center size-7 text-sm font-semibold rounded-lg border border-transparent text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white dark:border-transparent dark:hover:bg-neutral-700" data-hs-overlay="#hs-createModal">
        ...
        <div class="p-4 sm:p-10 overflow-y-auto">
          ...
          <div class="space-y-4">
                {{-- form --}}
                <form action="{{ route('admin.establishment.store') }}" method="post">
                    @csrf
                    <div class="mt-4">
                        <div class="p-2 shadow">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-2 px-3 bg-gray-100 rounded-lg dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number="">
                                    ...
                                    <div class="flex items-center gap-x-1.5">
                                        ...
                                        <input name="parking_price" class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white" type="text" value="0" data-hs-input-number-input="">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-2 px-3 bg-gray-100 rounded-lg dark:bg-neutral-900 dark:border-neutral-700" data-hs-input-number="">
                                    ...
                                    <div class="flex items-center gap-x-1.5">
                                        ...
                                        <input name="establishment_slot" class="p-0 w-6 bg-transparent border-0 text-gray-800 text-center focus:ring-0 dark:text-white" type="text" value="0" data-hs-input-number-input="">
                                        <button type="button" class="size-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800" data-hs-input-number-increment="">
                                        <svg class="flex-shrink-0 size-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M5 12h14"></path>
                                            <path d="M12 5v14"></path>
                            ...
                            <div class="mb-2 flex justify-center gap-2">
                                <button type="button" class="w-[50%] bg-red-500 p-2 text-white rounded-md hover:bg-red-700" data-hs-overlay="#hs-createModal">
                                    Cancel
                                  </button>
                                <button type="submit" class="w-[50%] bg-violet-500 p-2 text-white rounded-md hover:bg-violet-700">Save Information</button>
                            </div>
                        </div>
