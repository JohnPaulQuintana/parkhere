  ...
  <div
      ...
      <div
          ...
          <div class="p-4 sm:p-10 overflow-y-auto">
              ...
              <div class="space-y-4">
                  {{-- form --}}
                  <form id="booked-form" action="{{ route('admin.reservation.paid') }}" method="post">
                      @csrf
                      <input type="number" id="booked_id" name="booked_id" class="hidden">
                      <div class="mt-4">
                                      ...
                                      <div
                                          ...
                                          <div class="w-full flex justify-between items-center gap-x-3">
                                              ...
                                              <div class="flex items-center gap-x-1.5">
                                                  ...
                                                  <input id="es" name="parking_price"
                                                      class="p-0 w-fit font-bold text-end bg-transparent border-0 text-violet-500 focus:ring-0 dark:text-white"
                                      ...
                                      <div
                                          ...
                                          <div class="w-full flex justify-between items-center gap-x-3">
                                              ...
                                              <div class="flex items-center gap-x-1.5">
                                                  ...
                                                  <input id="parking_price" name="parking_price"
                                                      class="p-0 w-fit font-bold text-end bg-transparent border-0 text-violet-500 focus:ring-0 dark:text-white"
                                          ...
                                          <div class="w-full flex justify-between items-center gap-x-3">
                                              ...
                                              <div class="flex items-center gap-x-1.5">
                                                  ...
                                                  <input id="parking_slot_selected" name="slot"
                                                      class="p-0 w-fit pr-[14px] font-bold text-end bg-transparent border-0 text-violet-500 focus:ring-0 dark:text-white"
                                                      type="text" value="" readonly>
                                      ...
                                      <div
                                          ...
                                          <div class="w-full flex justify-between items-center gap-x-3">
                                              <div>
                                                  ...
                                                  <span id="statusClass" class="statusClass block text-xs text-red-500 dark:text-neutral-400">
                                                      <i
                                              ...
                                              <div class="flex items-center gap-x-1.5">
                                                  ...
                                                  <input id="charges_total" name="slot"
                                                      class="statusClass p-0 w-fit font-bold text-end bg-transparent border-0 text-red-500 focus:ring-0 dark:text-white"
                                                      type="number" value="" readonly>
